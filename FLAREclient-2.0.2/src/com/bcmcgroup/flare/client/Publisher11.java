...
public class Publisher11 {
	...
	public void publish(String cN, HashMap<String,String> extHdrs, String msg, List<ContentBlock> cBlocks) throws IOException {	
		...
		logger.debug("Publisher11 signInboxMessage statusList: " + signResult);
		if (signResult) {
			...
			HttpsURLConnection conn = TaxiiUtil.buildConnection(config.getProperty("taxii11serverUrlInbox"));
