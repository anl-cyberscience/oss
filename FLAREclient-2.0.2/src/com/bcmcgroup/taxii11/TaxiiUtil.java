...
public class TaxiiUtil {
	...
	public static final java.lang.String VID_TAXII_SERVICES_11 = "urn:taxii.mitre.org:services:1.1";
	public static final java.lang.String VID_TAXII_XML_10 = "urn:taxii.mitre.org:message:xml:1.0";
	public static final java.lang.String VID_TAXII_XML_11 = "urn:taxii.mitre.org:message:xml:1.1";
	public static final java.lang.String VID_TAXII_HTTP_10 = "urn:taxii.mitre.org:protocol:http:1.0";
	...
	public static Document discoveryResponse(String msgId, String iRT, HashMap<String,String> extHdrs, ArrayList<ServiceInstance> serviceList) {
		...
		if (iRT != null) {
			...
			logger.error("Discovery_Response iRT cannot be null, returning null document");
			return null;
		}
		...
		for (ServiceInstance si : serviceList) {
			if (si.appendToDocument(taxiiDoc)) {
				continue;
			} else {
				return null;
			}
	...
	public static ArrayList<ServiceInstance> getServiceList() {
		ArrayList<ServiceInstance> returnList = new ArrayList<ServiceInstance>();
